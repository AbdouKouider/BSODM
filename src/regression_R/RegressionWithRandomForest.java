...
public class RegressionWithRandomForest {
	 ...
	 */
	public static double predictAsolutionClass(byte [] solution)
	{

		double predictedFitness=0;
        ...
        Map results = RegressionR.evaluator.evaluate( params );
       // System.out.println(results);
       // System.out.println(results.values().toArray()[1]);
        predictedFitness= (double) results.values().toArray()[1];
